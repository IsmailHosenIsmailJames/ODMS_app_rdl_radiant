...
import 'package:rdl_radiant/src/screens/visit%20customer/details_view_customers.dart';

import '../../apis/apis.dart';
import '../../theme/text_scaler_theme.dart';
import '../../widgets/common_widgets_function.dart';
import '../customer_location/model/customer_list_model.dart';

class VisitsCustomerPage extends StatefulWidget {
  const VisitsCustomerPage({super.key});

  @override
  State<VisitsCustomerPage> createState() => _VisitsCustomerPageState();
}

class _VisitsCustomerPageState extends State<VisitsCustomerPage> {
